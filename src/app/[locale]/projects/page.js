                            ...
                            <Card
                                ...
                                <CardContent>
                                    ...
                                    <div className="hidden md:flex items-center px-4 py-3 border-b ">
                                        ...
                                        <div className="w-[225px] font-medium">{lan('all-projects.project')}</div>
                                        <div className="flex-1 font-medium">{lan('all-projects.technologies')}</div>
                                        <div className="w-[100px] text-right font-medium">{lan('all-projects.links')}
                                        </div>
                                    </div>
