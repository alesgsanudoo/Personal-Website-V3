        ...
        <>
                            ...
                            <span>
                                ...
                                <TooltipContent side="right"
                                    ...
                                    <p>{isExpanded ? lan('sidebar-option-close') : lan('sidebar-option-open')} sidebar <kbd
                                        className="ml-2 rounded border px-1 text-xs text-orange-500 border-orange-500">B</kbd>
                                    </p>
                                </TooltipContent>
                            </Tooltip>
                        </TooltipProvider>
            ...
            <main className="relative z-10 flex-1 overflow-y-auto flex items-center justify-center">
                <div className="container mx-auto py-8 px-4 md:px-8 lg:px-16 xl:px-32 text-center ">
                    <div>
                        <h1 className="text-9xl md:text-[12rem] lg:text-[15rem] font-bold text-amber-500 mb-6 select-none animate-pulse">
                            404
                        </h1>
                        ...
                        <Link
                            href="/"
                            className="inline-flex items-center gap-2 bg-amber-500 text-white px-6 py-3 rounded-lg text-lg font-semibold hover:bg-amber-600 transition-colors"
                        >
            ...
            <footer className="relative z-10 flex mb-10 flex-col space-y-2 mt-5 pr-4 pl-4 items-center">
                <h2 className="text-gray-500">
                    {lan('footer.paragraph1')}<a href="https://github.com/alesgsanudoo" target="_blank"
                                                 className="font-bold text-amber-500 hover:text-amber-700">Alex</a> ❤️!
                </h2>
                <h2 className="text-gray-500 text-center">
                    {lan('footer.paragraph2')}<a href="https://nextjs.org/" target="_blank"
                                                 className="font-bold text-amber-500 hover:text-amber-700">NextJS</a>{lan('footer.paragraph3')}<a
                    href="https://tailwindcss.com/" target="_blank"
                    className="font-bold text-amber-500 hover:text-amber-700">TailwindCSS</a>.
                </h2>
            </footer>
        </>
    )
